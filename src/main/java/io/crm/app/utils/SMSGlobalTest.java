...
public class SMSGlobalTest {
     ...
     */
    public SMSGlobalTest(String newApiKey, String newSecretKey, String newApiURL, int newPort) {
     ...
     */
    public String makeGetRequest(String endPoint, String responseContentType, HashMap<String, String> params) throws Exception {
        String response = "";
     ...
     * @throws MalformedURLException, ProtocolException, IOException, Exception
     */
    public String makePostRequest(String endPoint, String requestContentType, String responseContentType, HashMap<String, String> params) throws Exception {
        String response = "";
        String timeStamp = Long.toString(Instant.now().getEpochSecond());
        String nonce = this.generateRandomString(32);
     ...
     */
    public String getOutGoingMessages(String responseContentType, HashMap<String, String> params) throws Exception {
        String endPoint = "/v2/sms/";
        return this.makeGetRequest(endPoint, responseContentType, params);
    }

    public String sendMessage(String requestContentType, String responseContentType, HashMap<String, String> params) throws Exception {
        String endPoint = "/v2/sms/";
        return this.makePostRequest(endPoint, requestContentType, responseContentType, params);
    }
